...
public class SMClass {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        NV10ControlJNI.delete_SMClass(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  static public class StateMachine_t {
    ...
    public synchronized void delete() {
      if (swigCPtr != 0) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          NV10ControlJNI.delete_SMClass_StateMachine_t(swigCPtr);
        }
        swigCPtr = 0;
      }
    }
    ...
    public void setCurrState(SMClass.State_t value) {
      NV10ControlJNI.SMClass_StateMachine_t_CurrState_set(swigCPtr, this, value.swigValue());
    }
  
    public SMClass.State_t getCurrState() {
      return SMClass.State_t.swigToEnum(NV10ControlJNI.SMClass_StateMachine_t_CurrState_get(swigCPtr, this));
    }
  
    public StateMachine_t() {
      this(NV10ControlJNI.new_SMClass_StateMachine_t(), true);
    }
  
  }

  public SMClass(NV10Class _NV10Class_p) {
    this(NV10ControlJNI.new_SMClass(NV10Class.getCPtr(_NV10Class_p), _NV10Class_p), true);
  }

  public void setSM(SMClass.StateMachine_t value) {
    NV10ControlJNI.SMClass_SM_set(swigCPtr, this, SMClass.StateMachine_t.getCPtr(value), value);
  }

  public SMClass.StateMachine_t getSM() {
    long cPtr = NV10ControlJNI.SMClass_SM_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SMClass.StateMachine_t(cPtr, false);
  }

  public void setLS(SMClass.StateMachine_t value) {
    NV10ControlJNI.SMClass_LS_set(swigCPtr, this, SMClass.StateMachine_t.getCPtr(value), value);
  }

  public SMClass.StateMachine_t getLS() {
    long cPtr = NV10ControlJNI.SMClass_LS_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SMClass.StateMachine_t(cPtr, false);
  }

  public void setEvento(SMClass.Event_t value) {
    NV10ControlJNI.SMClass_Evento_set(swigCPtr, this, value.swigValue());
  }

  public SMClass.Event_t getEvento() {
    return SMClass.Event_t.swigToEnum(NV10ControlJNI.SMClass_Evento_get(swigCPtr, this));
  }

  public void setEstado(SMClass.State_t value) {
    NV10ControlJNI.SMClass_Estado_set(swigCPtr, this, value.swigValue());
  }

  public SMClass.State_t getEstado() {
    return SMClass.State_t.swigToEnum(NV10ControlJNI.SMClass_Estado_get(swigCPtr, this));
  }

  public void InitStateMachine() {
    NV10ControlJNI.SMClass_InitStateMachine(swigCPtr, this);
  }

  public int RunCheck() {
    return NV10ControlJNI.SMClass_RunCheck(swigCPtr, this);
  }

  public int StateMachineRun(SMClass.Event_t Event) {
    return NV10ControlJNI.SMClass_StateMachineRun(swigCPtr, this, Event.swigValue());
  }

  public String StateMachineGetStateName(SMClass.State_t State) {
    return NV10ControlJNI.SMClass_StateMachineGetStateName(swigCPtr, this, State.swigValue());
  }
  ...
  public final static class State_t {
    ...
    public final static SMClass.State_t ST_DISABLE = new SMClass.State_t("ST_DISABLE");
    ...
    private static State_t[] swigValues = { ST_IDLE, ST_CONNECT, ST_DISABLE, ST_ENABLE, ST_POLLING, ST_CHECK, ST_ERROR };
  ...
  public final static class Event_t {
    ...
    private static Event_t[] swigValues = { EV_ANY, EV_SUCCESS_CONN, EV_CALL_POLLING, EV_CHECK, EV_READY, EV_FINISH_POLL, EV_POLL, EV_LOOP, EV_RESET, EV_ERROR };
    private static int swigNext = 0;
    private final int swigValue;
    private final String swigName;
  }
